<template>
    <div class="flex flex-1 min-h-0 min-w-0 flex-col max-sm:overflow-y-auto sm:flex-row">
        ...
        <div class="w-full flex-none overflow-visible pb-4 sm:w-77 sm:overflow-y-auto sm:pb-0 sm:pr-4">
        ...
        <!-- Right side tabs -->
        <div class="flex min-w-0 flex-col max-sm:flex-none sm:min-h-0 sm:flex-1 sm:pl-4">
            <TabsUnderline
