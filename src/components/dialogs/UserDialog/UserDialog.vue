<template>
    <div class="user-dialog-scrollbars flex-1 min-h-0 min-w-0 flex flex-col max-md:overflow-y-auto md:flex-row">
        ...
        <div class="flex-none w-full md:w-77 md:overflow-y-auto md:pr-4">
            <UserSummaryHeader
