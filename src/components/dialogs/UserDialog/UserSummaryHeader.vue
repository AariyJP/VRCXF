    ...
    <div class="rounded-xl bg-muted/40 overflow-hidden flex flex-col">
        <div class="relative aspect-17/6">
            <div
                ...
                :style="{
                    backgroundColor: userDialog.ref.bannerColor
                        ? `#${userDialog.ref.bannerColor}`
                        : 'hsl(var(--muted))',
                }"
            ></div>
            <img
            ...
            <div
                ...
                style="
                    width: 96px;
                    height: 96px;
                    filter: drop-shadow(0 0 1px rgb(0 0 0 / 0.95))
        ...
        <div class="flex flex-col gap-2 px-3 pb-3 pt-15">
            <div class="flex items-start gap-1.5">
                <div class="flex-1 min-w-0">
                    <div
                        class="flex flex-wrap items-center gap-x-1 leading-snug"
                    >
                        <template
                            v-if="userDialog.previousDisplayNames.length > 0"
                        >
                    ...
                    >
                        <TooltipWrapper v-if="userDialog.ref.status" side="top">
                            ...
                            <i
                                class="x-user-status mt-0.5 flex-none"
                                :class="userStatusClass(userDialog.ref)"
                            ></i>
                        </TooltipWrapper>
                        <div class="min-w-0">
                            <span
                                ...
                                >{{ getUserStateText(userDialog.ref) }}</span
                            >
                            <span
                                v-if="userDialog.ref.statusDescription"
                                class="block wrap-anywhere"
                                >{{ userDialog.ref.statusDescription }}</span
                            >
                        </div>
                    </div>
                </div>
            ...
            >
                <TooltipWrapper
                    side="top"
                    :content="t('dialog.user.tags.trust_level')"
                >
                    <Badge
                        variant="outline"
                ...
                >
                    ...
                    >
                        <i
                            class="ri-discord-line inline-flex mt-0.5 h-2.5 w-2.5 items-center justify-center text-[10px] leading-none before:block before:leading-none"
                        ></i>
                ...
                >
                    <Badge
                        variant="outline"
                        class="h-5 w-5 p-0 text-platform-pc border-platform-pc!"
                    >
                ...
                >
                    <Badge
                        variant="outline"
                        class="h-5 w-5 p-0 text-platform-quest border-platform-quest!"
                    >
                ...
                >
                    <Badge
                        variant="outline"
                        class="h-5 w-5 p-0 text-platform-ios border-platform-ios"
                    >
            ...
            <div
                v-if="
                    userDialog.ref.$languages &&
                    userDialog.ref.$languages.length
                "
            ...
            <div
                v-if="userDialog.ref.badges && userDialog.ref.badges.length"
                                    ...
                                    >
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                @update:modelValue="
                                                    toggleBadgeShowcased(badge)
                                                "
                                            />
                                            <span>{{
                                                t(
                                                    "dialog.user.badges.showcased",
                                                )
                                            }}</span>
                                        </label>
                                    </template>
            ...
            <div
                ...
                class="border-t border-border flex flex-col gap-1.5"
            >
                <div
    ...
    <div class="rounded-xl bg-muted/40 p-3 flex flex-col mt-2">
        ...
        >
            <div class="flex-1 min-w-0">
                <div class="text-xs font-medium truncate">
                    <span
                        v-if="
                            userDialog.representedGroup.ownerId ===
                            userDialog.id
                        "
                        class="mr-1"
                        >👑</span
        ...
        <div class="mt-2">
            <img
                ...
                @click="
                    showFullscreenImageDialog(
                        userDialog.representedGroup.bannerUrl,
                    )
                "
                loading="lazy"
            />
